...
public class DrawingView extends View{
	...
	protected void onSizeChanged(int w, int h, int oldw, int oldh) {
		...
		if (bitmapArray != null){
		    animal = BitmapFactory.decodeResource(getResources(),bitmapArray[0]);
		    double difference = (double)animal.getHeight() / (double)animal.getWidth();
			...
			partImage = BitmapFactory.decodeResource(getResources(),bitmapArray[1]);
			partImage = Bitmap.createScaledBitmap(partImage, tmpW, tmpH, false);
			color = constColors.get(0);
			Shader mShader1 = new BitmapShader(partImage, Shader.TileMode.CLAMP,Shader.TileMode.CLAMP);
			drawPaint.setShader(mShader1);
			
			activity.setActiveColor(0, color + "_s");
			
			canvasBitmap = Bitmap.createBitmap(animal.getWidth(), animal.getHeight(), Bitmap.Config.ARGB_8888);
			getLayoutParams().height = animal.getHeight();
			getLayoutParams().width = animal.getWidth();
			drawCanvas = new Canvas(canvasBitmap);
			super.onSizeChanged(animal.getWidth(), animal.getHeight(), oldw, oldh);
		}
		else
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		float touchY = event.getY();
			...
			case MotionEvent.ACTION_UP:
				...
				for (String colr : colorsName)
				{
					Log.d("Buble" , "Left : " + colr);
				}
				Log.d("Buble" , "ColorNameSize : " + colorsName.size());
				
				if (colorsName.size() == 0)
				{
					Toast.makeText(context, "Level Finished", Toast.LENGTH_LONG).show();
					SharedPreferences prefs = context.getSharedPreferences("com.bublecat.drawer", Activity.MODE_PRIVATE);
	...
	private boolean compare(Bitmap canvas , Bitmap main)
	{
		...
		Log.d("Buble" , "Percents : " + percents);
		Log.d("Buble" , "Count : " + count + "  Color : " + color);
	...
	public void setBrushColor(int colorId)
	{
		...
		case R.id.first_color:
			...
			Shader mShader1 = new BitmapShader(partImage, Shader.TileMode.REPEAT,Shader.TileMode.REPEAT);
			drawPaint.setShader(mShader1);
		...
		case R.id.second_color:
			...
			partImage.recycle();
			partImage = BitmapFactory.decodeResource(getResources(),bitmapArray[2]);
			partImage = Bitmap.createScaledBitmap(partImage, w, h, false);
			mShader1 = new BitmapShader(partImage, Shader.TileMode.REPEAT,Shader.TileMode.REPEAT);
			drawPaint.setShader(mShader1);
			activity.setDefaultColor(constColors);
		...
		case R.id.third_color:
			...
			partImage.recycle();
			partImage = BitmapFactory.decodeResource(getResources(),bitmapArray[3]);
			partImage = Bitmap.createScaledBitmap(partImage, w, h, false);
			mShader1 = new BitmapShader(partImage, Shader.TileMode.REPEAT,Shader.TileMode.REPEAT);
			drawPaint.setShader(mShader1);
			activity.setDefaultColor(constColors);
		...
		case R.id.fourth_color:
			...
			partImage.recycle();
			partImage = BitmapFactory.decodeResource(getResources(),bitmapArray[4]);
			partImage = Bitmap.createScaledBitmap(partImage, w, h, false);
			mShader1 = new BitmapShader(partImage, Shader.TileMode.REPEAT,Shader.TileMode.REPEAT);
			drawPaint.setShader(mShader1);
			activity.setDefaultColor(constColors);
		...
		case R.id.fifth_color:
			...
			partImage.recycle();
			partImage = BitmapFactory.decodeResource(getResources(),bitmapArray[5]);
			partImage = Bitmap.createScaledBitmap(partImage, w, h, false);
			mShader1 = new BitmapShader(partImage, Shader.TileMode.REPEAT,Shader.TileMode.REPEAT);
			drawPaint.setShader(mShader1);
			activity.setDefaultColor(constColors);
		...
		case R.id.six_color:
			...
			partImage.recycle();
			partImage = BitmapFactory.decodeResource(getResources(),bitmapArray[6]);
			partImage = Bitmap.createScaledBitmap(partImage, w, h, false);
			mShader1 = new BitmapShader(partImage, Shader.TileMode.REPEAT,Shader.TileMode.REPEAT);
			drawPaint.setShader(mShader1);
			activity.setDefaultColor(constColors);
		...
		case R.id.seven_color:
			...
			partImage.recycle();
			partImage = BitmapFactory.decodeResource(getResources(),bitmapArray[7]);
			partImage = Bitmap.createScaledBitmap(partImage, w, h, false);
			mShader1 = new BitmapShader(partImage, Shader.TileMode.REPEAT,Shader.TileMode.REPEAT);
			drawPaint.setShader(mShader1);
			activity.setDefaultColor(constColors);
		...
		case R.id.eight_color:
			...
			partImage.recycle();
			partImage = BitmapFactory.decodeResource(getResources(),bitmapArray[8]);
			partImage = Bitmap.createScaledBitmap(partImage, w, h, false);
			mShader1 = new BitmapShader(partImage, Shader.TileMode.REPEAT,Shader.TileMode.REPEAT);
			drawPaint.setShader(mShader1);
			activity.setDefaultColor(constColors);
